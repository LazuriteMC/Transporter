...
/**
 * The packet responsible for syncing the item buffer from the client to the server.
 * @see Transporter#onInitializeClient()
 * @see PatternBuffer
 * @see BufferStorage
 */
public class TransportItemBufferC2S {
    public static final Identifier PACKET_ID = new Identifier(Transporter.MODID, "transport_item_buffer_c2s");
